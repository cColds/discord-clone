...
const TabItem = ({ name, selected, onTabClick }: TabItemProps) => {
  return (
    <li
      className={cn(
        "py-1.5 px-2.5 mb-0.5 rounded text-md leading-5 truncate list-none text-interactive-normal cursor-pointer hover:text-interactive-hover hover:bg-background-modifier-hover",
        selected
